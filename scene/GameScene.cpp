...
void GameScene::Initialize() {
	...
	//子
	worldTransforms_[PartId::Spine].translation_ = { 0,4.5,0 };
...
#pragma endregion 
	...
	////カメラ垂直方向視野角を設定
	//viewProjection_.fovAngleY = 3.14f / 180.0f * 104.0f;
